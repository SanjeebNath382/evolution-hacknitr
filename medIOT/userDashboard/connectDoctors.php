...
<html style="font-size: 16px;">
  <head>
    ...
    <title>Connect with doctors</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="./connectDoctor.css" media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-1573"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
          ...
          <div class="u-custom-menu u-nav-container">
            <ul class="u-nav u-unstyled u-nav-1"><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="./index.php" style="padding: 10px 20px;">Dasboard</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" target="_blank" href="../healthChecker/index.php" style="padding: 10px 20px;">AI tool</a>
</li></ul>
          </div>
          <div class="u-custom-menu u-nav-container-collapse">
            <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
              <div class="u-sidenav-overflow">
                ...
                <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="./index.php" style="padding: 10px 20px;">Dasboard</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="../healthChecker/index.php" target="_blank" style="padding: 10px 20px;">AI tool</a>
</li></ul>
              </div>
            </div>
    ...
    <div id="content-home" style="margin-left:500px">
            <div id='doc-results'>
                <div class='product-card'>
                <img src='assets/doc.jpg' class='product-img'></img>
                     <div class='product-content'>
                        <h1 class='product-name'>Dr Aman Dewangan</h1>
                        <h3 style="color:white;">Gynaecologist(M.S.) MBBS</h3>
                        <a href="./video_call/index.php" target="_blank"><button class="doc-button">Connect</Button></a>
                    </div></a>
                </div>
            </div>
            <div id='doc-results'>
                ...
                <img src='assets/doc.jpg' class='product-img'></img>
                     <div class='product-content'>
                        <h1 class='product-name'>Dr Sanjeeb Nath</h1>
            ...
            <div id='doc-results'>
                ...
                <img src='assets/doc.jpg' class='product-img'></img>
                     <div class='product-content'>
                        <h1 class='product-name'>Dr Aryan Sarkar</h1>
